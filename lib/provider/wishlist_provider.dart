...
import 'package:Anwar/data/model/response/wishlist_model.dart';
  ...
  Future<void> initWishList(BuildContext context) async {
    ...
    if (apiResponse.response != null &&
      ...
      apiResponse.response.data.forEach((wishList) async {
        ApiResponse productResponse = await productDetailsRepo
            .getProduct(WishListModel.fromJson(wishList).productId.toString());
